...
import com.inseoul.svc.travels.TravelsListService;
...
public class TravelsListAction implements Action {
  /* ----------------------------------------------------------------------------------------------------
  ...
  public ActionForward execute(HttpServletRequest request,HttpServletResponse response) throws Exception{
    ArrayList<TravelsListBean> travelsList = new ArrayList<TravelsListBean>();
    int page = 1;
    int limit = 8;
    int range = 10;
    ...
    TravelsListService travelsListService = new TravelsListService();
    int listCount = travelsListService.getListCount(Integer.parseInt(pid), category, search, keywords);
    travelsList = travelsListService.getTravelsList(page, limit, Integer.parseInt(pid), Integer.parseInt(uid), category, search, keywords);
    ...
    request.setAttribute("travelsList", travelsList);
