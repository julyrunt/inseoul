...
public class BucketReplyListAction implements Action {
  /* ----------------------------------------------------------------------------------------------------
  ...
  public ActionForward execute(HttpServletRequest request,HttpServletResponse response) throws Exception{
    ...
    int listCount = bucketReplyListService.getListCount(bid);
    replyList = bucketReplyListService.getReplyList(bid, replyPage, limit);
