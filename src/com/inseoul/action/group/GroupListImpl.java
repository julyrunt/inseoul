...
public class GroupListImpl implements ProfileCommandInter{

  static GroupListImpl impl = new GroupListImpl();
  /* ----------------------------------------------------------------------------------------------------
   * 
   * ---------------------------------------------------------------------------------------------------- */
  public static GroupListImpl instance(){
    return impl;
  }
  /* ----------------------------------------------------------------------------------------------------
   * 
  ...
  public String showData(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    int listCount = model.selOwnGroupCount(pageInfo);
    ...
    ArrayList<GroupListBean> list = (ArrayList<GroupListBean>) model.selOwnGroupList(pageInfo);
  ...
  public String runData(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    if (uid != null && group != null) {
      boolean isDeleted = model.delGroup(pageInfo);
      if (isDeleted) {
        out.print("1");
      } else {
        out.print("0");
