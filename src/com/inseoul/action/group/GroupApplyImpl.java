...
public class GroupApplyImpl implements ProfileCommandInter{

  static GroupApplyImpl impl = new GroupApplyImpl();
  /* ----------------------------------------------------------------------------------------------------
   * 
   * ---------------------------------------------------------------------------------------------------- */
  public static GroupApplyImpl instance(){
    return impl;
  }
  /* ----------------------------------------------------------------------------------------------------
   * 
  ...
  public String showData(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    int listCount = model.selApplyGroupCount(pageInfo);
    ...
    ArrayList<GroupListBean> list = (ArrayList<GroupListBean>) model.selApplyGroupList(pageInfo);
