...
import com.inseoul.svc.follow.FollowerListService;
...
public class FollowerListAction implements Action {
  ...
  public ActionForward execute(HttpServletRequest request,HttpServletResponse response) throws Exception{
    ...
    FollowerListService followerListService = new FollowerListService();
    int listCount = followerListService.getListCount(pid);
    followerList = followerListService.getFollowerList(pid, uid, page, limit);
