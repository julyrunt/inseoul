$( function() {
	...
	$(document).on("change", "#img01", function() {
		...
		if(files.length < 1){
			$("#preview01").css('background-image', '');
			$("#file-name01").html("선택된 파일 없음");
		}
		var file = files[0];
		...
		$("#file-name01").html($(this).val().split(/(\\|\/)/g).pop());
		checkFileSize();
	})
	$(document).on("change", "#img02", function() {
		var files = $(this)[0].files;
		if(files.length < 1){
			$("#preview02").css('background-image', '');
			$("#file-name02").html("선택된 파일 없음");
		}
		var file = files[0];
		var reader = new FileReader();
		reader.onloadend = function (e) {
		...
		reader.readAsDataURL(file);
		$("#file-name02").html($(this).val().split(/(\\|\/)/g).pop());
		checkFileSize();
	})
	$(document).on("change", "#img03", function() {
		var files = $(this)[0].files;
		if(files.length < 1){
			$("#preview03").css('background-image', '');
			$("#file-name03").html("선택된 파일 없음");
		}
		var file = files[0];
		var reader = new FileReader();
		reader.onloadend = function (e) {
		...
		reader.readAsDataURL(file);
		$("#file-name03").html($(this).val().split(/(\\|\/)/g).pop());
		checkFileSize();
	});	
	$(document).on("change", "#img04", function() {
		var files = $(this)[0].files;
		if(files.length < 1){
			$("#preview04").css('background-image', '');
			$("#file-name04").html("선택된 파일 없음");
		}
		var file = files[0];
		var reader = new FileReader();
		reader.onloadend = function (e) {
		...
		reader.readAsDataURL(file);
		$("#file-name04").html($(this).val().split(/(\\|\/)/g).pop());
		checkFileSize();
	})
	$(document).on("change", "#img05", function() {
		var files = $(this)[0].files;
		if(files.length < 1){
			$("#preview05").css('background-image', '');
			$("#file-name05").html("선택된 파일 없음");
		}
		var file = files[0];
		var reader = new FileReader();
		reader.onloadend = function (e) {
		...
		reader.readAsDataURL(file);
		$("#file-name05").html($(this).val().split(/(\\|\/)/g).pop());
		checkFileSize();
	})
	$(document).on("change", "#img06", function() {
		var files = $(this)[0].files;
		if(files.length < 1){
			$("#preview06").css('background-image', '');
			$("#file-name06").html("선택된 파일 없음");
		}
		var file = files[0];
		var reader = new FileReader();
		reader.onloadend = function (e) {
		...
		reader.readAsDataURL(file);
		$("#file-name06").html($(this).val().split(/(\\|\/)/g).pop());
		checkFileSize();
	})
	$(document).on("change", "#img07", function() {
		var files = $(this)[0].files;
		if(files.length < 1){
			$("#preview07").css('background-image', '');
			$("#file-name07").html("선택된 파일 없음");
		}
		var file = files[0];
		var reader = new FileReader();
		reader.onloadend = function (e) {
		...
		reader.readAsDataURL(file);
		$("#file-name07").html($(this).val().split(/(\\|\/)/g).pop());
		checkFileSize();
	})
	$(document).on("change", "#img08", function() {
		var files = $(this)[0].files;
		if(files.length < 1){
			$("#preview08").css('background-image', '');
			$("#file-name08").html("선택된 파일 없음");
		}
		var file = files[0];
		var reader = new FileReader();
		reader.onloadend = function (e) {
		...
		reader.readAsDataURL(file);
		$("#file-name08").html($(this).val().split(/(\\|\/)/g).pop());
		checkFileSize();
	})
	$(document).on("change", "#img09", function() {
		var files = $(this)[0].files;
		if(files.length < 1){
			$("#preview09").css('background-image', '');
			$("#file-name09").html("선택된 파일 없음");
		}
		var file = files[0];
		var reader = new FileReader();
		reader.onloadend = function (e) {
		...
		reader.readAsDataURL(file);
		$("#file-name09").html($(this).val().split(/(\\|\/)/g).pop());
		checkFileSize();
	})
	$(document).on("change", "#img10", function() {
		var files = $(this)[0].files;
		if(files.length < 1){
			$("#preview10").css('background-image', '');
			$("#file-name10").html("선택된 파일 없음");
		}
		var file = files[0];
		var reader = new FileReader();
		reader.onloadend = function (e) {
		...
		reader.readAsDataURL(file);
		$("#file-name10").html($(this).val().split(/(\\|\/)/g).pop());
		checkFileSize();
	})
})
