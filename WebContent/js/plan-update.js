...
//	var today = start_date.toISOString().substring(0, 10);
//	var maxDate = new Date();
//	var end_maxDate = new Date();
//	var start = new Date();
	
//	start.setDate(start.getDate());
//	var end_day = getFormatDate(start_date);
...
//		         console.log(string_arr + " " + day_string);
		   ...
		   console.log(result);
		   location.href = "planupdate.mk?mid="+mid + result +"&plan_end="+ dat1 + "&plan_start="+ dat2 + "&title=" + title ;
	});
}
