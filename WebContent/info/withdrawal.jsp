...
<link rel="stylesheet" type="text/css" href="../css/info-withdrawal.css">
<!-- 자바스크립트 -->
<script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<script type="text/javascript" src="../js/common.js"></script>
<script type="text/javascript" src="../js/profile-header.js"></script>
<script type="text/javascript" src="../js/info-withdrawal.js"></script>
</head>
<body>
	<c:if test="${uid == null}">
	...
	<c:if test="${uid != null}">
		...
		<main>
			<section>
				...
				<article>
					<form action="withdrawalPro.pr" onsubmit="return checkUpdatable()" method="post">
						<div class="input-label">비밀번호 확인</div>
						<div class="input-field">
							<input class="pw" type="password" name="pw" maxlength="20" onblur="pwCheck()" required="required">
							<span class="material-symbols-outlined pw-visibility">
								visibility_off
							</span>
						</div>
						<div class="input-alert">
							※ 회원 탈퇴시 모든 활동내역이 삭제됩니다.
						</div>
