...
<link rel="stylesheet" type="text/css" href="../css/group-management.css">
<!-- 자바스크립트 -->
<script
...
<body>
	...
	<div class="top-title">
		...
		<div class="titleBox">그 룹 관 리</div>
	</div>
	<section>
	<div id="manage-table">
			...
			<c:forEach var="gr" items="${groups}" varStatus="status">
				<c:if test="${gr.state eq 0}">
					<tr>
						...
						<td><input type="button" id="group-appro" value="수락" onclick="appro('${gr.uid}')"></td>
					</tr>
				</c:if>
				<c:if test="${gr.state eq 1}">
